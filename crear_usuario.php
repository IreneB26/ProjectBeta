...
<body class="crear_usuario">
    ...
    <form class="formulario_inicio_sesion" method="post" action="principal.php">
        ...
        <input class="input input_sesion" type="pasword" id="contraseña" name="contraseña" placeholder="Password">
    ...
    <div class="crear_cuenta">
        ...
        <p class="p_registro">¿No estás registrado? <a class="a_registro" href="#">Crea una cuenta</a></p>
